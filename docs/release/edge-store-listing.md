...
First manual submission through Partner Center: version 1.0.0 (not yet published). Later updates use the release workflow described in [Release pipeline](release-pipeline.md).
